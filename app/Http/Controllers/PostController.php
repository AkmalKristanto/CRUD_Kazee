...
class PostController extends Controller
{
    ...
    public function overview()
    {
        ...
        return view('overview', compact('posts'));
    ...
    public function store(StoreUpdatePostFormRequest $request)
    {
        ...
        return redirect()
                    ->route('posts.index')
                    ->withSuccess('Barang Telah di Tambahkan');
    }
    ...
    {
        $ret['posts'] = DB::table('posts')
            ->select(DB::raw('count(*) as jumlah'))
            ->get();
        // dd($ret);
        return view('posts.index')->with($ret);
    }
    ...
    public function update(StoreUpdatePostFormRequest $request, $id)
    {
        ...
        return redirect()
                    ->route('posts.index')
                    ->withSuccess('Barang Telah Di Edit');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()
                    ->route('posts.index')
                    ->withSuccess('Barang Telah Dihapus');
    }
}
